...
namespace Eniture\WweLtlFreightQuotes\Controller\Warehouse;
...
class WweLTLOriginAddress extends Action
{
    /**
     * @var Data Object
     */
    ...
    {
        $licenseKey = $this->scopeConfig->getValue('WweLtConnSettings/first/WweLtLicenseKey', ScopeInterface::SCOPE_STORE);
        $post = [
            'acessLevel' => 'address',
            'address' => $originZip,
