...
class InstallData implements InstallDataInterface
{
    ...
    public function install(
        ...
        $this->addWweLTLAttributes($installer, $eavSetup);
        $this->createWweLTLWarehouseTable($installer);
    ...
    public function renameOldAttributes()
    {
        ...
        if ($isspeedFreightExist == 1) {
            $dataArr = [
                ...
                'source_model' => 'Eniture\WweLtlFreightQuotes\Model\Source\WweLTLFreightClass',
            ];
    ...
    public function addWweLTLAttributes(
        ...
        if ($isdropshiplocationExist == null) {
            ...
            $dataArr = [
                'source_model' => 'Eniture\WweLtlFreightQuotes\Model\Source\DropshipOptions',
            ];
            $this->connection
     ...
     * @param $installer
     */
    public function createWweLTLWarehouseTable($installer)
    {
    ...
    public function createEnitureModulesTable($installer)
    {
        ...
        $newModuleName = 'ENWweLTL';
        $scriptName = 'Eniture_WweLtlFreightQuotes';
    ...
    public function checkLTLExistanceColumForEnModules($installer)
    {
        ...
        $this->connection->update($tableName, ['is_ltl' => 1], "module_name = 'ENWweLTL'");
        $installer->endSetup();
    }
